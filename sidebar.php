    ...
    <div class="sidebar pb-4 mb-4">
      <nav class="mt-2">
        ...
        <?php endif; ?>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link nav-edit_test">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./index.php?page=new_test" class="nav-link nav-new_test tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Add New</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./index.php?page=test_list" class="nav-link nav-test_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>List</p>
                </a>
              </li>
